...
import showSidebarIcon from "@/assets/icons/arrows/arrowLeftSimpleIcon.svg";
import hideSidebarIcon from "@/assets/icons/arrows/arrowRightSimpleIcon.svg";
  ...
  return (
    <div className={classes.sidebarWrapper}>
      <div
        ...
        className={classes.showSidebarIconWrapper}
      >
        {showSidebar ? (
          <img src={showSidebarIcon} alt="show sidebar" />
        ) : (
          <img src={hideSidebarIcon} alt="hide sidebar" />
        )}
      </div>
      {showSidebar ? (
        <div className={classes.contractDetailsSidebar}>
          ...
          <div className={classes.actionButtons}>
            <button className={classes.newContractBtn}>
              Կնքել նոր պայմանագիր
            </button>
            <button className={classes.updateInfoBtn}>
              Թարմացնել տվյալները
            </button>
          </div>
        </div>
      ) : (
        <div className={classes.collapsedSidebarPlaceholder}>
